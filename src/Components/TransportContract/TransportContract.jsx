          ...
          <div className="contract-body">
            ...
            <div className="header">
              <div className="logo-box">
                <div className="logo-text">
                  ...
                  <div>الرقم الضريبي ( ٣١١٤٩٦٩١٥٦٠٠٠) </div>
                </div>
              </div>
            ...
            <div className="meta-row">
              <div className="contract-row">
                ...
                <p>
                  رقم الرحلة / <span className="red-text">{trip.id}</span>
                </p>
                <p>
                  رقم العقد / <span className="red-text">8955601</span>
                </p>
              </div>

              <p>
                تم إبرام هذا العقد بين المتعاقدين بناء على المادة (٣٩) التاسعة والثلاثون من الأنظمة
                المنظمة لنشاط النقل المتخصص وتأجير و توجيه الحافلات وبناء على الفقرة (١) من المادة (٢٩)
                والتي تنص على ان يجب على الناقل إبرام عقد نقل مع الاطراف المحددين في المادة (٤٠) قبل
                تنفيذ عمليات النقل على الطرق البرية و بما ال يخالف أحكام هذه اللائحة و وفقا الآلية التي
                تحددها هيئة النقل و بناء على ما سبق تم إبرام عقد النقل بين الأطراف الآتية
              </p>
            </div>
            ...
            <table className="my-table first-party">
              ...
              <tbody>
                <tr>
                  <th rowSpan={3} style={{ color: "#3399ff" }}>
                    الطرف الأول
                  </th>
            ...
            <div className="conditions">
              <p>
                اتفق الطرفان على أن ينفذ الطرف الأول عملية النقل للطرف الثاني مع مرافقيه و ذويهم من الموقع المحدد مسبقا من
                الطرف الثاني و توصيلهم إلى الجهة المحددة بالعقد .
              </p>
            </div>
            ...
            <div className="conditions">
              <p>
                في حالة الغاء التعاقد لأي سبب شخصي أو أسباب أخرى تتعلق في الحجوزات او الأنظمة تكون سياسة الإلغاء و
                الاستبدال
              </p>
              <p>
                و في حالة طلب الطرف الثاني الحجز من خلال الموقع الإلكتروني للمؤسسة يعتبر هذا الحجز و موافقه على الشروط و
                الأحكام بالموقع الإلكتروني هو موافقة على هذا العقد لتنفيذ عملية النقل المتفق عليها مع الطرف الأول بواسطة
                حافلات المؤسسة المرخصة و المتوافقة مع الاشتراطات المقدرة من هيئة النقل .
              </p>
            </div>
          </div>
          ...
          <div className="wrapper-box">
            <div className="driver-notice-box">
              ...
              <div className="content-box">
                ...
                >
                  برجاء الإلتزام بتعليمات الهيئة العامة للنقل و تعليمات المؤسسة، أي مخالفة تعرض السائق للمساءلة.
                </span>
                ,
                <hr />

                <p className="english bold">
                  Please comply with the regulations of the Public Transport Authority and the company’s guidelines. Any
                  violation will lead to accountability. Our goal: Respectfully serving passengers and reflecting a positive
                  image of the Kingdom.Thank you for your cooperation.Ebdaat Al-Obour Transport <br />
                  <span className="company">Edbatat Al-Obour Transport</span>
                </p>
                <hr />
                <p className="urdu">
                  براه کرم پبلک ٹرانسپورٹ اتهارٹی کے قوانين اور ادارے کی ہدايات پر عمل کريں۔ کسی بهی خلاف ورزی کی صورت ميں
                  آپ کو جوابده ٹهہرايا جائے گا۔ ہمارا مقصد: مسافروں کی عزت کے ساته خدمت اور مملکت کی اچهی شبيہ پيش کرنا ہے۔
                  تعاون کا شکريہ۔ ابداعات العبور ٹرانسپورٹ.
                </p>
              </div>
            </div>
            <div className="image-box">
              <img src="/car.img5.jpg" alt="صورة" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="contract-outer">
        <div className="contract-inner">
          ...
          <div className="header-image">
            <img src="/iiamge8.png" alt="Header" />
          </div>
          <div
            style={{
